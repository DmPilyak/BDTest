...
public class DijkstraAlgoritm {
    ...
    public void calculateShortestPathFromSource(Graph graph, Node source) {
        ...
        while (unsettledNodes.size() != 0) {
            Node currentNode = new DijkstraAlgoritm().getLowestDistanceNode(unsettledNodes);
            ...
            for (Entry<Node, Integer> adjacencyPair : currentNode.getAdjacentNodes().entrySet()) {
                ...
                if (!settledNodes.contains(adjacentNode)) {
                	new DijkstraAlgoritm().calculateMinimumDistance(adjacentNode, edgeWeigh, currentNode);
